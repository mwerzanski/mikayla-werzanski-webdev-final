            ...
            <div className="text-center">
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={e => this.onChange('firstName', e)}></input>
                </div>
                ...
                <div>
                    <label htmlFor="duplicatePassword" className="mr-4">
                        Confirm Password:
                    </label>
                    <input
                        type="password"
                        ...
                        onChange={e =>
                            this.onChange('duplicatePassword', e)
                        }></input>
                </div>
                ...
                <div>
                    ...
                    />
                    <label htmlFor="adminAccess" className="ml-4">
                        Admin Access
                    </label>
                </div>
                ...
                {this.state.error !== '' && (
                    <div className="text-danger text-center pt-4">
                        Please try a unique username and make sure your password
