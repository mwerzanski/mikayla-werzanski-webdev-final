    ...
    render() {
        ...
        return (
            <div className='text-center'>
                ...
                {
                    this.state.error !== '' &&
                    <h4 className='text-danger text-center pt-4'>Username or password is incorrect. Please try again.</h4>
                }

                <Link to='/Login' className='btn btn-outline-success' onClick={() => this.login()}>Login</Link>
            </div>
