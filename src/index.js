    ...
    <Provider store={store}>
        <Router>
            ...
            <Route
                exact
                path="/CreateUser"
                component={CreateUserComponent}></Route>
            <Route
                exact
                path="/UserProfile/:userID"
                component={ProfileComponent}></Route>
            <Route exact path="/Menu/:userID" component={MenuItemList}></Route>
            <Route
                path={['/Help', '/Help/:userID']}
                component={HelpComponent}
            />
            <Route
                exact
                path="/ViewUsers/:userID"
                component={AdminUserComponent}></Route>
            <Route
                exact
                path="/CreateMenuItem/:userID"
                component={CreateMenuItem}></Route>
            <Route
                exact
                path="/UpdateMenuItem/:userID"
                component={UpdateMenuItem}></Route>
            <Route
                exact
                path="/ViewUsers/:userID/ViewMenu/:username"
                component={AdminMenuComponent}></Route>
            <Route
                exact
                path={[
                    '/ViewNutritionInformation/:userID',
                    '/ViewNutritionInformation',
                ]}
                component={SearchNutrition}></Route>
        </Router>
    </Provider>,
